app.controller('ReportsController',
		function($scope, $http, $cookies) {
			...
			$scope.loadReportPage = function(page) {
				var pageSize = 15;
				$scope.reportsResp = {};
				$scope.reportsResp.invoiceReports = angular
						.copy($scope.invoiceReports);
				$scope.reportsResp.invoiceReports.splice(pageSize * page,
						$scope.invoiceReports.length - pageSize);
				$scope.reportsResp.invoiceReports.splice(0, pageSize
						* (page - 1));
